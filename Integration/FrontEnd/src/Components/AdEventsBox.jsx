import './EventBox.css';
import './AdEventBox.css';
import { useState } from 'react';
import axios from 'axios';
import { useNavigate } from 'react-router-dom';


function AdEventsBox() {
        ...
        <div>
            <div className="ad-modal-container">
                ...
                <div className="ad-evnt-create-box">
                    <div className=''>
                        <a href="/addevents"><img className="ad-img" src="https://openclipart.org/image/2400px/svg_to_png/183568/close-button.png"></img></a>
