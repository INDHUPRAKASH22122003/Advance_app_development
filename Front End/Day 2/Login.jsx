...
const Login = () => {
  ...
  <div className='login-pg'>
        <div className="login-page">
			...
			<input type='password'/>
			<Link className='lk' to="/home"><button className='login-button'>Sign In</button></Link>
			<Link to="/showtheme" className='rs1'><p className='rs'>No Account? Register Now</p></Link>
      </div>
	{/* <div className="box">
		<form>
