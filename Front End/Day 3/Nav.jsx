      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            <Link to="/home" className='hms'>
            <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>Home</Button>
            </Link>
            <Link to="/theme" className='hms'>
              <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>Theme</Button>
            </Link>
            <Link to="/gh" className='hms'>
              <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>Photography</Button>
            </Link>
            <Link to="/gh" className='hms'>
              <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>Sounds/Lights</Button>
            </Link>
            <Link to="/gh" className='hms'>
              <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>Add-On</Button>
            </Link>
            <Link to="/about" className='hms'>
              <Button onClick={handleCloseNavMenu} sx={{ my: 2, color: 'white', display: 'block' }}>About US</Button>
            </Link>
            <Link to="/contact" className='hms'>
